...
MD_HEAD = """## ChinoBing's Blog: https://chinobing.github.io 
...
ABOUT_LABELS = ["About"]
# DRAFT_LABEL = '草稿'
FRONT_LABELS = ['一、','二、','三、','四、','五、','六、','七、','八、','九、','十、']
...
def add_md_label(repo, md, me):
    ...
    with open(md, "a+", encoding="utf-8") as md:
        ...
        j = 0 #inital index for FRONT_LABELS
        for label in labels:
...
def main(token, repo_name, issue_number=None, dir_name=BACKUP_DIR):
    ...
    # md_file = workspace_path+"/README.md"
    md_file = "README.md"
    # add to readme one by one, change order here
    add_md_header(md_file, repo_name)
